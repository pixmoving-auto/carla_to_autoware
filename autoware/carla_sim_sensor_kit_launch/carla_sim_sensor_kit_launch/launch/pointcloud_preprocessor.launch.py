...
def launch_setup(context, *args, **kwargs):
    ...
    #         {
    #             "input_topics": [
    #                 "/sensing/lidar/lf/outlier_filtered/pointcloud",
    #                 "/sensing/lidar/lr/outlier_filtered/pointcloud",
    #                 "/sensing/lidar/rf/outlier_filtered/pointcloud",
    #                 "/sensing/lidar/rr/outlier_filtered/pointcloud",
    ...
    concat_loader = LoadComposableNodes(
        ...
        composable_node_descriptions=[cropbox_component, cropbox_component_1],
